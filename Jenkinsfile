...
<<<<<<< HEAD
               ...
               sh 'cd webapp && sudo docker run --rm -e SONAR_HOST_URL="http://31.101.131.209:9000/" -v ".:/usr/src" -e SONAR_TOKEN="sqp_0ecccbc398b22165d361c15a791b2de06166c04d" sonarsource/sonar-scanner-cli -Dsonar.projectKey=lms'
